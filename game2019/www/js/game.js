...
function preload() {
    ...
    this.load.image('primus_pic', './imgs/primus.png');
...
function create() {
    ...
    // primus = this.add.tileSprite((window.innerWidth/2), (window.innerHeight/2), window.innerWidth, window.innerHeight, 'primus_pic');
    primus = this.add.sprite((window.innerWidth/2), (window.innerHeight * 0.7), 'primus_pic');

    primus.displayWidth = window.innerWidth;
    primus.displayHeight = window.innerHeight * 0.8;
